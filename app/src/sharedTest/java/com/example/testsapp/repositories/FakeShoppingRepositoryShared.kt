...
//This one is supposed to simulate the behaviour of our normal repository and supposed to be used in
// the test of the view model
class FakeShoppingRepositoryShared : ShoppingRepository {
